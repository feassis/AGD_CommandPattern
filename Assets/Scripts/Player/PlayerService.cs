...
namespace Command.Player
{
    public class PlayerService
    {
        ...
        public void PerformAction(ActionType actionSelected, UnitController targetUnit, bool isSuccesful) => GameService.Instance.ActionService.GetActionByType(actionSelected).PerformAction(activePlayer.GetUnitByID(ActiveUnitID), targetUnit, isSuccesful);
